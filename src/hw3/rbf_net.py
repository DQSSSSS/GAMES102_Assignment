...
def train_model(model, x_train, y_train, x_min, x_max, y_min, y_max):
...
def test_model(model, x_test, x_min, x_max, y_min, y_max):
...
if __name__ == "__main__":
    ...
    model = get_new_model(30)

    epo, loss = train_model(model, x_train, y_train, x_min, x_max, y_min, y_max)
    ...
    y_test = test_model(model, x_test, x_min, x_max, y_min, y_max)
    draw(x_train, y_train, x_test, y_test)
